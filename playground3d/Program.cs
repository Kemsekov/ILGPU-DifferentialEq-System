...
var solutions = solver.EnumerateSolutions(initialValues,dt,t0,h,1,2,3);
...
foreach(var s in solutions.Take(n)){
    ...
    Buffer.BlockCopy(s.Values[0],0,res,0,xsize*ysize*sizeof(double));
    plt.Add.Heatmap(res);
    plt.SavePng($"images/{counter}.png",500,500);
    }
